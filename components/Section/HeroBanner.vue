<template>
   <div class="hero min-h-[calc(100vh-var(--header-height))] lg:min-h-screen h-full pt-[calc(var(--header-height)+20px)] -mt-[var(--header-height)] flex items-center py-4">
      <div class="container grid gap-4 lg:grid-cols-2 lg:items-center">
         <div class="lg:order-1 order-2 flex flex-col gap-6 sm:gap-10 max-w-[586px] w-full">
            ...
            <div class="flex flex-wrap gap-2 sm:gap-4">
                  ...
                  <DialogContent class="sm:max-w-[700px] p-10 !rounded-3xl">
                     <div class="flex flex-col gap-10">
                        <div class="flex flex-col gap-3 md:gap-6">
                           <h2 class="text-lg md:text-2xl xl:text-3xl font-semibold">Qisqa vaqt ichida mutaxasisslar tomonidan bepul konsultatsiya oling!</h2>
                     ...
                     <form @submit.prevent="submitForm" class="flex flex-col gap-6">
                        ...
                        <div class="flex sm:items-center justify-between sm:flex-row flex-col gap-5">
                           <div class="flex items-center space-x-2">
                              ...
                              <Label for="agreee" class="text-base leading-none"> Согласие с политикой обработки данных </Label>
                           </div>
                           <Button type="submit" :disabled="!isFormValid" class="sm:max-w-[300px] w-full max-sm:px-3 max-sm:py-2">
               ...
               <Button variant="outline">{{ translations['main.btn1'] }}</Button>
            </div>
         </div>
         <div class="lg:order-2 order-1">
            <img src="/assets/images/Rectangle 78.png" alt="" class="lg:max-w-[700px] lg:h-[400px] w-full object-cover ml-auto rounded-lg" />
         </div>
      </div>
   </div>
</template>
