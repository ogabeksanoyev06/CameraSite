            ...
            <div class="max-w-[600px] md:ml-auto w-full md:py-10 p-4">
               <div class="flex flex-col gap-6 sm:gap-10">
                  <div class="flex flex-col gap-3 md:gap-6">
                     <h2 class="text-lg md:text-2xl xl:text-3xl font-semibold text-white">Qisqa vaqt ichida
                        mutaxasisslar tomonidan bepul konsultatsiya oling!</h2>
                  ...
                  <form @submit.prevent="submitForm">
                     <div class="grid grid-cols-1 sm:grid-cols-2 gap-6 mb-6">
                        <input type="text" placeholder="Ism familyangiz" v-model="form.first_name"
                     ...
                     <div class="flex sm:items-center justify-between sm:flex-row flex-col gap-5">
                        <div class="flex items-center space-x-2">
                           ...
                           <Label for="agree" class="text-white text-base leading-none"> Согласие с политикой обработки
                              данных </Label>
                        </div>
