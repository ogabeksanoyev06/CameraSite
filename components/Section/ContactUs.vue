   ...
   <div class="contact-bg">
      <div class="">
         <div class="flex md:grid flex-col-reverse grid-cols-1 items-center md:grid-cols-2 gap-6 md:gap-20">
            <div class="max-w-[600px] md:ml-auto w-full md:py-10 p-4">
               <div class="flex flex-col gap-6 sm:gap-10">
                  <div class="flex flex-col gap-3 md:gap-6">
                     <h2 class="text-lg md:text-2xl xl:text-3xl font-semibold text-white">Qisqa vaqt ichida mutaxasisslar tomonidan bepul konsultatsiya oling!</h2>
                     <div class="flex items-center gap-4">
                        <img src="/assets/images/2.png" alt="" class="w-10 h-10 object-cover rounded-full" />
                        <div class="flex flex-col gap-2">
                           <p class="text-base font-medium text-white">Baxtjon Chapaev</p>
                           <p class="text-xs text-green-100">+998 99 165 32 45</p>
                        </div>
                     </div>
                  </div>
                  <form @submit.prevent="submitForm">
                     ...
                     <div class="flex sm:items-center justify-between sm:flex-row flex-col gap-5">
                        <div class="flex items-center space-x-2">
                           ...
                           <Label for="agree" class="text-white text-base leading-none"> Согласие с политикой обработки данных </Label>
                        </div>
            ...
            <div class="md:h-[460px] max-w-[920px] relative before:absolute before:bg-[#1878F3B2] before:inset-0 before:w-full before:h-full clip-path-custom">
