   ...
   <div class="bg-[#F5F5F7] py-20">
      <div class="container flex flex-col gap-6">
         ...
         <div class="grid grid-cols-1 xl:grid-cols-2 gap-6">
            <div class="flex xl:items-center flex-col lg:flex-row gap-4 lg:gap-8 overflow-hidden relative p-4 lg:p-8 xl:p-12 bg-white rounded-[24px]">
               ...
               <div class="flex flex-col items-start gap-4 sm:gap-6">
                  ...
                  <Button variant="link" class="p-0">
                     <span class="text-base text-blue">{{ translations['main.btn1'] }}</span>
                     <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <path d="M5.83331 5.83337L9.16665 10L5.83331 14.1667" stroke="#1878F3" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" />
                        <path d="M10.8333 5.83337L14.1666 10L10.8333 14.1667" stroke="#1878F3" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" />
                     </svg>
                  </Button>
               </div>
            </div>
