<template>
   <header
      id="header"
      class="relative w-full z-50 transition-300"
         ...
         <div class="flex items-center justify-between border-b border-gray-500 h-20">
            <div class="mr-4 md:mr-1 flex items-center">
               ...
               <nav class="hidden lg:flex items-center gap-1 text-sm font-medium">
                  <NuxtLink :to="localePath('/about')" class="aa lg:px-3 xl:px-4 py-2 relative nav z-10 rounded-lg text-white">
                  ...
                  <HoverCard>
                     ...
                     <HoverCardContent class="flex flex-col gap-1 p-0 whitespace-nowrap w-full">
                        <NuxtLink :to="localePath('/services/1')" class="lg:px-3 hover:text-primary xl:px-4 py-1 relative nav z-10 rounded-lg text-black">
                           Yong‘in signalizatsiya tizimlarini o‘rnatish xizmati
                        </NuxtLink>
                        <NuxtLink :to="localePath('/services/2')" class="lg:px-3 hover:text-primary xl:px-4 py-1 relative nav z-10 rounded-lg text-black">
                           Kuzatuv kameralar tizimlarini o‘rnatish xizmati
                        </NuxtLink>
                     </HoverCardContent>
                  </HoverCard>

                  <NuxtLink :to="localePath('/portfolio')" class="aa lg:px-3 xl:px-4 py-2 relative nav z-10 rounded-lg text-white">
                     {{ translations['header.portfolio'] }}
                  </NuxtLink>
                  <NuxtLink :to="localePath('/products')" class="aa lg:px-3 xl:px-4 py-2 relative nav z-10 rounded-lg text-white">
                     {{ translations['header.products'] }}
                  </NuxtLink>
                  <NuxtLink :to="localePath('/contacts')" class="aa lg:px-3 xl:px-4 py-2 relative nav z-10 rounded-lg text-white">
            ...
            <Sheet>
               <SheetTrigger as-child>
                  <Button size="icon" class="flex lg:hidden rounded-[8px] !border-white/40 !bg-white/5 backdrop-blur-[8px]">
                     <svg xmlns="http://www.w3.org/2000/svg" width="40" height="40" viewBox="0 0 40 40" fill="none">
                        <path d="M11.6666 13.3335H28.3333M11.6666 20.0002H28.3333M11.6666 26.6668H28.3333" stroke="#fff" stroke-width="1.5" stroke-linecap="round"></path>
                     </svg>
                  </Button>
               </SheetTrigger>
                  ...
                  <div class="flex flex-col space-y-2 text-center sm:text-left">
                     <NuxtLink to="/" class="text-center flex justify-center w-full">
                        <svg width="143" height="16" viewBox="0 0 143 16" fill="none" xmlns="http://www.w3.org/2000/svg">
                           <path d="M16.6444 0.468085L10.1143 15.4894H6.57123L0 0.468085H4.0169L8.36339 11.5532L12.7305 0.468085H16.6444Z" fill="#020105" />
                           ...
                           <path
                              ...
                              fill="#020105"
                           />
                           <path d="M58.9041 15.4894H44.9376V0.468085H58.4921V3.17021H48.5837V6.55319H58.1625V9.23404H48.5837V12.8085H58.9041V15.4894Z" fill="#020105" />
                           <path
                     ...
                     <nav class="flex nav-mobile flex-col text-left rounded-md bg-background py-4">
                        <SheetClose as-child> <NuxtLink to="/about" class="rounded-md px-4 py-2 text-primary">Kompaniya haqida</NuxtLink> </SheetClose>
                        <Accordion type="single" collapsible>
                           <AccordionItem value="item-1" class="border-none">
                              <AccordionTrigger class="hover:no-underline font-normal rounded-md px-4 py-2 text-primary"> Xizmatlar</AccordionTrigger>
                              <AccordionContent>
                                 <SheetClose as-child> <NuxtLink to="/services/1" class="rounded-md">Yong‘in signalizatsiya tizimlarini o‘rnatish xizmati</NuxtLink></SheetClose>
                              </AccordionContent>
                              <AccordionContent>
                                 <SheetClose as-child> <NuxtLink to="/services/2" class="rounded-md">Kuzatuv kameralar tizimlarini o‘rnatish xizmati</NuxtLink></SheetClose>
                              </AccordionContent>
                           </AccordionItem>
                        </Accordion>
                        <SheetClose as-child> <NuxtLink to="/portfolio" class="rounded-md px-4 py-2 text-primary">Portfolio</NuxtLink> </SheetClose>
                        <SheetClose as-child> <NuxtLink to="/products" class="rounded-md px-4 py-2 text-primary">Mahsulotlar</NuxtLink> </SheetClose>
                        <SheetClose as-child> <NuxtLink to="/contacts" class="rounded-md px-4 py-2 text-primary">Kontaktlar </NuxtLink> </SheetClose>
                     </nav>
                  </div>

                  <SheetFooter>
                     <div class="flex flex-col w-full">
                        <div class="flex items-center gap-2 bg-muted py-2 px-2 rounded-tl rounded-tr border-b cursor-pointer">
            ...
            <div class="hidden lg:flex flex-1 items-center justify-end space-x-4 xl:space-x-10">
               <DropdownMenu v-model:open="isDropdownOpen">
                  <DropdownMenuTrigger @click="toggleDropdown" class="flex items-center gap-2">
                     ...
                     >
                        <path d="M5.83301 8.33333L9.99967 11.6667L14.1663 8.33333" stroke="white" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" />
                     </svg>
                  </DropdownMenuTrigger>
                  <DropdownMenuContent>
